"""
Django settings for bookstore_clerk project.
...
SECRET_KEY = 'django-insecure-2$a&-6hu*vlohzc_!i#l0qe!2k&gbej$6qe@!q3w*p%fr2uv%('
...
ROOT_URLCONF = 'bookstore_clerk.urls'
...
WSGI_APPLICATION = 'bookstore_clerk.wsgi.application'
